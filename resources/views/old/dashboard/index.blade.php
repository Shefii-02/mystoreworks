                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            <p class="text-muted text-sm m-0 ">{{ __('Total') }}</p>
                                            <div class="d-flex gap-3 ">
                                                <a href="{{ route('customer.index') }}"
                                                    class="text-primary fw-bold">{{ __('Customers') }}</a>
                                                <h3 class="m-0 text-primary fw-bold fs-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            <p class="text-muted text-sm m-0 text-info">{{ __('Total') }}</p>
                                            <div class="d-flex gap-3">
                                                <a href="{{ route('vender.index') }}"
                                                    class="text-info">{{ __('Vendors') }}
                                                </a>
                                                <h3 class="mb-0 text-info fw-bold fs-5">{{ \Auth::user()->countVenders() }}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <div class="d-flex gap-3">
                                                <a href="{{ route('invoice.index') }}"
                                                    class="text-warning">{{ __('Invoices') }}
                                                </a>
                                                <h3 class="mb-0 text-warning fw-bold fs-5">
                                                    {{ \Auth::user()->countInvoices() }} </h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <div class="d-flex gap-3">
                                                <a href="{{ route('bill.index') }}"
                                                    class="text-danger">{{ __('Bills') }}</a>
                                                <h3 class="mb-0 text-danger fs-5">{{ \Auth::user()->countBills() }} </h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
